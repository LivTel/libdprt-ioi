/* ngat_dprt_ioi_DpRtLibrary.c
** Implementation of Java Classes ngat.dprt.ioi.DpRtLibrary.java native Interfaces
** $Header: /space/home/eng/cjm/cvs/libdprt-ioi/c/ngat_dprt_ioi_DpRtLibrary.c,v 1.1 2013-09-04 15:19:19 cjm Exp $
*/
/**
 * ngat_dprt_ioi_DpRtLibrary.c is the  `glue' between libdprt_ioi and ngat.dprt.ioi.DpRtLibrary.java.
...
#include <string.h>
#include <jni.h>
#include "ngat_dprt_ioi_DpRtLibrary.h"
#include "dprt.h"
 ...
 */
static char rcsid[] = "$Id: ngat_dprt_ioi_DpRtLibrary.c,v 1.1 2013-09-04 15:19:19 cjm Exp $";
...
/**
 * Class:     ngat_dprt_ioi_DpRtLibrary<br>
 * Method:    DpRt_Initialise<br>
 * Signature: ()V<br>
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.ioi.DpRtLibrary this method was called with.
 ...
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Initialise(JNIEnv *env,jobject object)
{
	int retval;
 ...
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.ioi.DpRtLibrary this method was called with.
 * Java Native Interface implementation ngat.dprt.ioi.DpRtLibrary's shutdown.
 * @see dprt.html#DpRt_Shutdown
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Throw_Exception
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Shutdown(JNIEnv *env,jobject object)
{
	int retval;
 ...
 * Java Native Interface implementation ngat.dprt.ioi.DpRtLibrary's setStatus.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Status
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Set_1Status(JNIEnv *env,jobject object,jobject status)
{
 ...
 * Java Native Interface implementation ngat.dprt.ioi.DpRtLibrary's initialiseLoggerReference.
 ...
 * @param l The DpRtLibrary's "ngat.dprt.ioi.DpRtLibrary" logger.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Initialise_Logger_Reference
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_initialiseLoggerReference(JNIEnv *env,jobject obj,jobject l)
{
 ...
 * Signature: ()V<br>
 * This native method is called from ngat.dprt.ioi.DpRtLibrary's finaliser method. It removes the global reference to
 * logger.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Finalise_Logger_Reference
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_finaliseLoggerReference(JNIEnv *env, jobject obj)
{
 ...
 * JNI interface routine called when ngat.dprt.ioi.DpRtLibrary.DpRtCalibrateReduce is called.
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.ioi.DpRtLibrary this method was called with.
 ...
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Calibrate_1Reduce(JNIEnv *env, jobject object, 
 ...
 * JNI interface routine called when ngat.dprt.ioi.DpRtLibrary.DpRtExposeReduce is called.
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.ioi.DpRtLibrary this method was called with.
 * @param input_filename_string The Java String object representing the filename string to be processed.
 ...
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Expose_1Reduce(JNIEnv *env,jobject object,
								 jstring input_filename_string,jobject reduce_done)
{
	char error_string[DPRT_ERROR_STRING_LENGTH];
	const char *input_filename = NULL;
 ...
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Reduce_Done
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Make_1Master_1Bias(JNIEnv *env, jobject object, 
 ...
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Reduce_Done
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Make_1Master_1Flat(JNIEnv *env, jobject object, 
 ...
 * Signature: ()V<br>
 * JNI interface routine called when ngat.dprt.ioi.DpRtLibrary.DpRtAbort is called.
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.ioi.DpRtLibrary this method was called with.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Abort
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Abort(JNIEnv *env, jobject object)
{
 ...
 */
JNIEXPORT void JNICALL Java_ngat_dprt_ioi_DpRtLibrary_DpRt_1Finalise_1References(JNIEnv *env,jobject object)
{
