/* dprt_test.c
** $Header: /space/home/eng/cjm/cvs/libdprt-ioi/test/dprt_test.c,v 1.1 2013-09-04 15:19:24 cjm Exp $
*/
/**
 * dprt_test.c Tests libdprt_ioi, the Data Pipeline Real Time
 ...
 */
static char rcsid[] = "$Id: dprt_test.c,v 1.1 2013-09-04 15:19:24 cjm Exp $";
/**
...
static void Help(void)
{
	fprintf(stdout,"dprt_test Tests the reduction routines in libdprt_ioi.\n");
